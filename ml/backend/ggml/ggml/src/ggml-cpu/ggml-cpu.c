...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TQ3_0_WHT] = {
        .from_float               = quantize_row_tq3_0_wht,
        .vec_dot                  = ggml_vec_dot_tq3_0_wht_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_TQ4_0_WHT] = {
        .from_float               = quantize_row_tq4_0_wht,
        .vec_dot                  = ggml_vec_dot_tq4_0_wht_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_TQ3_KV] = {
        .from_float               = quantize_row_tq3_kv,
        .vec_dot                  = ggml_vec_dot_tq3_kv_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_I32] = {
