...
static void set_rows_cuda(ggml_backend_cuda_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ...
    if (dst->type == GGML_TYPE_F32) {
    ...
    } else if (dst->type == GGML_TYPE_TQ3_0_WHT) {
        set_rows_cuda_quant<idx_t, block_tq3_0, QK_K, quantize_f32_tq3_0_wht_block>(
    ...
    } else if (dst->type == GGML_TYPE_TQ4_0_WHT) {
        set_rows_cuda_quant<idx_t, block_tq4_0, QK_K, quantize_f32_tq4_0_wht_block>(
    ...
    } else if (dst->type == GGML_TYPE_TQ3_KV) {
        ...
        // Reuse TQ3_KV quantize path (same block format, same WHT+centroid quantization)
        set_rows_cuda_quant<idx_t, block_tq3_kv, QK_TQ3_KV, quantize_f32_tq3_kv_block>(
            src0_d, src1_d, (block_tq3_kv*)dst->data,
            ne00, ne01, ne02, ne03,
            ne10, ne11, ne12, ne13,
