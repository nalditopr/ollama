...
func AsMap() map[string]EnvVar {
	ret := map[string]EnvVar{
		...
		"OLLAMA_KV_CACHE_TYPE":      {"OLLAMA_KV_CACHE_TYPE", KvCacheType(), "Quantization type for the K/V cache: f16, q8_0, q4_0, tq3, tq4, turbo3 (3.5bpw FA-enabled), turbo4 (4.25bpw FA-enabled) (default: f16)"},
